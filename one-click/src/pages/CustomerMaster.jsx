      ...
      <div className="pr-print-only">
        <div className="pr-ph-row">
          ...
          <div className="pr-ph-right">
            <div className="pr-ph-title">CUSTOMER REPORT</div>
        ...
        <div className="pr-ps-strip">
          <div className="pr-ps-cell">
            <span className="pr-ps-label">Total Customers</span>
            <span className="pr-ps-value">{filtered.length}</span>
          </div>
          <div className="pr-ps-cell">
            <span className="pr-ps-label">With Mobile</span>
            <span className="pr-ps-value pr-ps-green">{filtered.filter(c => c.mobileNo).length}</span>
          </div>
          <div className="pr-ps-cell">
            <span className="pr-ps-label">With GST</span>
            <span className="pr-ps-value pr-ps-blue">{filtered.filter(c => c.gstTin).length}</span>
          </div>
          <div className="pr-ps-cell pr-ps-accent">
            <span className="pr-ps-label">States Covered</span>
            <span className="pr-ps-value pr-ps-money">{new Set(filtered.map(c => c.state).filter(Boolean)).size}</span>
          </div>
        </div>
        <table className="pr-pt">
          <thead>
            <tr>
              ...
              <th className="pr-pt-th">Customer ID</th>
              <th className="pr-pt-th">Name</th>
              <th className="pr-pt-th">Mobile</th>
              <th className="pr-pt-th">Contact No.</th>
          ...
          <tbody>
            {filtered.map((c, i) => (
              <tr key={c.id} className={i % 2 === 1 ? 'pr-pt-alt' : ''}>
                ...
                <td className="pr-pt-td pr-pt-bold pr-pt-blue">{c.customerId}</td>
                <td className="pr-pt-td pr-pt-bold">{c.customerName}</td>
                <td className="pr-pt-td">{c.mobileNo || '—'}</td>
                <td className="pr-pt-td">{c.contactNo || '—'}</td>
                <td className="pr-pt-td">{c.state || '—'}</td>
                <td className="pr-pt-td">{c.gstTin || '—'}</td>
              </tr>
            ))}
          </tbody>
        </table>
