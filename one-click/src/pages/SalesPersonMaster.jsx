      ...
      <div className="pr-print-only">
        <div className="pr-ph-row">
          ...
          <div className="pr-ph-right">
            <div className="pr-ph-title">SALES PERSON REPORT</div>
        ...
        <div className="pr-ps-strip">
          <div className="pr-ps-cell">
            <span className="pr-ps-label">Total Persons</span>
            <span className="pr-ps-value">{filtered.length}</span>
          </div>
          <div className="pr-ps-cell">
            <span className="pr-ps-label">Active</span>
            <span className="pr-ps-value pr-ps-green">{filtered.filter(p => p.visible).length}</span>
          </div>
          <div className="pr-ps-cell pr-ps-accent">
            <span className="pr-ps-label">Inactive</span>
            <span className="pr-ps-value pr-ps-red">{filtered.filter(p => !p.visible).length}</span>
          </div>
        </div>
        <table className="pr-pt">
          <thead>
            <tr>
              ...
              <th className="pr-pt-th">Employee ID</th>
              <th className="pr-pt-th">Name</th>
              <th className="pr-pt-th">Mobile</th>
              <th className="pr-pt-th">Contact No.</th>
              <th className="pr-pt-th">Email</th>
              <th className="pr-pt-th pr-pt-c">Active</th>
            </tr>
          </thead>
          <tbody>
            {filtered.map((p, i) => (
              <tr key={p.id} className={i % 2 === 1 ? 'pr-pt-alt' : ''}>
                ...
                <td className="pr-pt-td pr-pt-bold pr-pt-blue">{p.employeeId}</td>
                <td className="pr-pt-td pr-pt-bold">{p.name}</td>
                <td className="pr-pt-td">{p.mobile || '—'}</td>
                <td className="pr-pt-td">{p.contactNo || '—'}</td>
                <td className="pr-pt-td">{p.email || '—'}</td>
                <td className="pr-pt-td pr-pt-c">
                  <span className={p.visible ? 'pr-pt-badge-green' : 'pr-pt-badge-red'}>{p.visible ? 'Yes' : 'No'}</span>
                </td>
              </tr>
            ))}
          </tbody>
