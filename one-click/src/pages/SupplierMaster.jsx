      ...
      <div className="pr-print-only">
        <div className="pr-ph-row">
          ...
          <div className="pr-ph-right">
            <div className="pr-ph-title">SUPPLIER REPORT</div>
        ...
        <div className="pr-ps-strip">
          <div className="pr-ps-cell">
            <span className="pr-ps-label">Total Suppliers</span>
            <span className="pr-ps-value">{filtered.length}</span>
          </div>
          <div className="pr-ps-cell">
            <span className="pr-ps-label">With GST</span>
            <span className="pr-ps-value pr-ps-blue">{filtered.filter(s => s.gstTin).length}</span>
          </div>
          <div className="pr-ps-cell">
            <span className="pr-ps-label">With Mobile</span>
            <span className="pr-ps-value pr-ps-green">{filtered.filter(s => s.mobile).length}</span>
          </div>
          <div className="pr-ps-cell pr-ps-accent">
            <span className="pr-ps-label">States Covered</span>
            <span className="pr-ps-value pr-ps-money">{new Set(filtered.map(s => s.state).filter(Boolean)).size}</span>
          </div>
        </div>
        <table className="pr-pt">
          <thead>
            <tr>
              ...
              <th className="pr-pt-th">Supplier ID</th>
              <th className="pr-pt-th">Name</th>
              <th className="pr-pt-th">Contact Person</th>
              <th className="pr-pt-th">Mobile</th>
              <th className="pr-pt-th">State</th>
              <th className="pr-pt-th">GST TIN</th>
            </tr>
          </thead>
          <tbody>
            {filtered.map((sup, i) => (
              <tr key={sup.id} className={i % 2 === 1 ? 'pr-pt-alt' : ''}>
                <td className="pr-pt-td pr-pt-sr">{i + 1}</td>
                <td className="pr-pt-td pr-pt-bold pr-pt-blue">{sup.supplierId}</td>
                <td className="pr-pt-td pr-pt-bold">{sup.supplierName}</td>
                <td className="pr-pt-td">{sup.contactPerson || '—'}</td>
                <td className="pr-pt-td">{sup.mobile || '—'}</td>
                <td className="pr-pt-td">{sup.state || '—'}</td>
                <td className="pr-pt-td">{sup.gstTin || '—'}</td>
              </tr>
            ))}
          </tbody>
        </table>
